...
import { TestController, TestQuestionController, TestAttemptController, TestAnswerController } from './test.controller';

@Module({
  imports: [TypeOrmModule.forFeature([Test, TestQuestion, TestAttempt, TestAnswer])],
  controllers: [TestController, TestQuestionController, TestAttemptController, TestAnswerController],

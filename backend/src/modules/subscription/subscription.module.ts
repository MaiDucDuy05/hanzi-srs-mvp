...
import { SubscriptionController, DailyUsageController, LimitSettingsController } from './subscription.controller';

@Module({
  imports: [TypeOrmModule.forFeature([Subscription, DailyPracticeUsage, PracticeLimitSettings])],

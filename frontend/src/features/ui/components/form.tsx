...
const baseField =
 'w-full rounded-xl border border-light-bamboo bg-white px-3 py-2 text-sm text-foreground placeholder:text-gray-400 focus:border-brand focus:outline-none focus:ring-2 focus:ring-brand/30';

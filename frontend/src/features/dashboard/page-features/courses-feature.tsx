                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    <div className="flex-1 h-2.5 bg-[#eef7e9] rounded-full overflow-hidden">
                      <div className="h-full bg-[#8BC34A] rounded-full transition-all duration-500 ease-out" style={{ width: `${course.progress}%` }} />
                    </div>
                    <span className="text-[10px] font-bold text-[#4a6b38] w-7 text-right">{course.progress}%</span>
                  </div>
                  <p className="text-xs font-semibold text-gray-500">{course.completedLessons}/{course.totalLessons} Lessons</p>
                </div>
              </div>

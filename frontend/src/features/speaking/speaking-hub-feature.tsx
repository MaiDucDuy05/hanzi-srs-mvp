      ...
      {!loading && !error && (
        <div className="grid grid-cols-3 gap-4">
          ...
          <Card className="text-center">
            ...
            <p className="text-sm text-gray-500">{t('statGraded')}</p>
          </Card>
          <Card className="text-center">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            >
              {isGraded ? t('statusGraded') : t('statusPending')}
            </span>
          </div>
          <p className="mt-1 text-sm text-gray-500">
            {t('submittedAt', { date: new Date(attempt.submittedAt).toLocaleString('vi-VN') })}
          </p>
        </div>
      </div>

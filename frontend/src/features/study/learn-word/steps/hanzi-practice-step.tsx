    ...
    <div className="flex flex-col min-h-full items-center animate-in fade-in slide-in-from-bottom-8 duration-700 w-full relative">
      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-2 mt-auto">
        <button 
          ...
          className="w-full bg-[#1f5333] hover:bg-[#163f26] text-white py-3.5 text-lg rounded-2xl shadow-[0_10px_25px_-5px_rgba(31,83,51,0.4)] hover:shadow-[0_15px_30px_-5px_rgba(31,83,51,0.6)] hover:-translate-y-0.5 transition-all font-bold flex items-center justify-center gap-2 disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-[0_10px_25px_-5px_rgba(31,83,51,0.4)] cursor-pointer"
        >

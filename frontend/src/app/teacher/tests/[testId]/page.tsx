...
export default function ManageTestPage() {
  ...
  if (loading) return <TeacherGuard><PageLoading label="Đang tải..." /></TeacherGuard>;
  if (error || !test)
    return <TeacherGuard><ErrorState message={error ?? 'Không tìm thấy đề.'} onRetry={() => void load()} /></TeacherGuard>;

    ...
    <div className="flex flex-col gap-6 h-full justify-center">
      ...
      <div className="mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-[2rem] p-4 shadow-sm flex items-center gap-4 hover:-translate-y-1 transition-transform cursor-pointer">
            <img src="/assets/illustrations/bamboo/bamboo.png" alt="Bamboo" className="h-32 w-auto flex-shrink-0 object-contain" />
            <div className="flex-1">
              <h3 className="font-bold text-[#215b3b] text-lg">Animals</h3>
              <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                <div className="bg-[#8BC34A] h-2 rounded-full" style={{ width: '70%' }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[2rem] p-4 shadow-sm flex items-center gap-4 hover:-translate-y-1 transition-transform cursor-pointer">
            <img src="/assets/illustrations/bamboo/bamboo.png" alt="Bamboo" className="h-32 w-auto flex-shrink-0 object-contain" />
            <div className="flex-1">
              <h3 className="font-bold text-[#215b3b] text-lg">Family</h3>
              <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                <div className="bg-[#8BC34A] h-2 rounded-full" style={{ width: '40%' }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[2rem] p-4 shadow-sm flex items-center gap-4 hover:-translate-y-1 transition-transform cursor-pointer">
            <img src="/assets/illustrations/bamboo/bamboo.png" alt="Bamboo" className="h-32 w-auto flex-shrink-0 object-contain" />
            <div className="flex-1">
              <h3 className="font-bold text-[#215b3b] text-lg">Numbers</h3>
              <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                <div className="bg-[#8BC34A] h-2 rounded-full" style={{ width: '20%' }}></div>
              </div>
            </div>
          </div>

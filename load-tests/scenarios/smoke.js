...
// Smoke: sanity — student 2 + quiz 1 + admin 1 + achievements 1 + practice-variants 1, 2 iter mỗi VU, max 60s.
// Chạy mỗi PR. Quiz attempt là core flow chính của project.
export const options = {
  scenarios: {
    student: { exec: 'student', executor: 'per-vu-iterations', vus: 2, iterations: 2, maxDuration: '1m' },
    quiz: { exec: 'quiz', executor: 'per-vu-iterations', vus: 1, iterations: 2, maxDuration: '2m' },
